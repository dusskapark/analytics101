    ...
    var response_facebook = function (json){
      var video_list = json.content;
        video_list.forEach(function(v, i) {
            ...
            var facebookUrl = "https://www.facebook.com/dialog/share?app_id=1463571523951964&display=popup&redirect_uri="+ "http://vikicast.com/res/responseSuccess.html" +"&href=" + REDIRECT_URL;
